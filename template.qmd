...
function evaluate_knn(predictions, true_values)
    # Implement your evaluation metric here (e.g., accuracy)
    # For example, using accuracy as the evaluation metric
...
function predict_knn(temp_train, temp_test, precip_train; n_pca::Int)
    ...
    accuracy = evaluate_knn(precip_pred, precip_train)

        # return a matrix of predictions and the evaluation metric
    return precip_pred, accuracy
